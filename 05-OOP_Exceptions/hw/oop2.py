...
class Homework:
    def __init__(self, text: str, deadline: int, created: datetime.datetime = datetime.datetime.now()):
        self.text = text
...
class DeadlineError(Exception):
    """Error occurs because of the expired date of a homework"""
...
class Teacher(Human):
    ...
    @staticmethod
    def create_homework(homework_description: str, homework_duration: int):
        return Homework(homework_description, homework_duration)
